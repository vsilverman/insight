...
Configuration to make a very simple local VPC for a few instances
...
Configuration for a security group within our configured VPC local,
...
module "security-group_ssh" {
  ...
  name        = "do-ssh-sg"
  description = "Security group for SSH with port 22 open within VPC"
  vpc_id      = module.local_vpc.vpc_id
...
//  vpc_security_group_ids      = [module.open_all_sg.this_security_group_id, module.web_server_sg.this_security_group_id, module.security-group_ssh.this_security_group_id]
  vpc_security_group_ids      = [module.web_server_sg.this_security_group_id, module.security-group_ssh.this_security_group_id]
