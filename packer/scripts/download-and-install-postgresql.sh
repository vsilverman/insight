...
CREATE USER vsilverman;
ALTER ROLE vsilverman WITH PASSWORD 'insight';
GRANT ALL PRIVILEGES ON DATABASE monthlydb TO vsilverman;
\connect monthlydb;
...
git clone https://github.com/vsilverman/insight_devops_airaware.git
